...
export const twoByteInstructions = {6: 'LD B,', 14: 'LD C,', 16: 'RRCA', 22: 'LD D,', 24: 'JR', 30: 'LD E,', 32: 'JR NZ,', 38: 'LD H,', 40: 'JR Z,', 46: 'LD L,', 48: 'JR NC,', 54: 'LD [HL],', 56: 'JR C,', 62: 'LD A,', 198: 'ADD A,', 206: 'ADC A,', 214: 'SUB', 222: 'SBC A,', 224: 'LDH [{{op1}}],A', 230: 'AND', 232: 'ADD SP,', 238: 'XOR', 240: 'LDH A,[{{op1}}]', 246: 'OR', 248: 'LD HL,SP+', 254: 'CP'};
export const threeByteInstructions = {1: 'LD BC,', 194: 'JP NZ,', 195: 'JP', 17: 'LD DE,', 33: 'LD HL,', 8: 'LD [{{op1}}],SP', 202: 'JP Z,', 204: 'CALL Z,', 205: 'CALL', 49: 'LD SP,', 210: 'JP NC,', 212: 'CALL NC,', 196: 'CALL NZ,', 218: 'JP C,', 220: 'CALL C,', 234: 'LD [{{op1}}],A', 250: 'LD A,[{{op1}}]'};
